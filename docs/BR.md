...
The CA SHALL retain evidence and logs of CA key lifecycle management events (as set forth in Section 5.4.1.1) and Subscriber Certificate lifecycle management event audit logs (αs set forth in Section 5.4.1.2) for at least seven years. The CA SHALL retain any security event audit logs (as set forth in Section 5.4.1.3) for at least two years.
